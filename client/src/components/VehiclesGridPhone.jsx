      ...
      {/* <div style={{
        ...
        {vehicles.map((vehicle, index) => (
          <div className="grid-container-3"
            ...
            <div className="full-row" style={{ marginTop: '3px' }}> {vehicle.requires_payment == 1 ? (
              <TableButton
                label={"Pay Now"}
      ...
      <div style={{
        ...
        {vehicles.map((vehicle, index) => (
          <div className="grid-container-2"
            ...
            <div className="grid-item-bold">Year</div><div></div>
            <div className="grid-item-normal"> {vehicle.year || "N/A"}</div><div></div>
