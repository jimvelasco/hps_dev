...
export default function OwnersDashboard() {
  ...
  return (
    <div style={{ marginTop: "-2px",minHeight: "100vh", backgroundColor: "#f5f5f5", backgroundImage: `url('${backgroundImage}')`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
