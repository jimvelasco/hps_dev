          ...
          <div style={{ display: "block", marginBottom: "30px" }}>
            ...
            <p style={{ color: "#666", lineHeight: "1.6" }}>
              ...
              <div>
                ...
                <p>Contact Yampa View Property Management (PM) to request permission to temporarily park any vehicle not allowed per Yampa View regulations. You can call or send a message to the PM through the application once you have logged in as an owner or guest. </p>
                <ul>
